...
- Design depth: prefer deep modules with small interfaces; hide implementation details and pull complexity downward
- Design scope: avoid speculative features, abstractions, and configurability
- Design scale: use C4's system, container, component, and code levels as zoom vocabulary; create diagrams only when explicitly requested
